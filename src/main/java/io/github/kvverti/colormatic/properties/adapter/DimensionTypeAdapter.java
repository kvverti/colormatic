...
public class DimensionTypeAdapter extends TypeAdapter<DimensionType> {
    ...
    public DimensionType read(JsonReader in) throws IOException {
        ...
        return Registry.DIMENSION.get(new Identifier(id));
    }
    ...
    public void write(JsonWriter out, DimensionType value) throws IOException {
        if(value == null) {
            ...
            out.value(Registry.DIMENSION.getId(value).toString());
        }
    }
}
